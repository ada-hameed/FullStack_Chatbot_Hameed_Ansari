...
You need to upgrade to DataGridPro or DataGridPremium component to unlock this feature.` : (0, _formatErrorMessage2.default)(88));
    }
    if (!props.dataSource && (0, _pivoting.gridPivotActiveSelector)(apiRef)) {
  ...
  const setRowChildrenExpansion = React.useCallback((id, isExpanded) => {
    ...
    if (!currentNode) {
      throw new Error(process.env.NODE_ENV !== "production" ? `MUI X: No row with id #${id} found.` : (0, _formatErrorMessage2.default)(89, id));
    }
    if (currentNode.type !== 'group') {
      throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Only group nodes can be expanded or collapsed.' : (0, _formatErrorMessage2.default)(90));
    }
...
You need to upgrade to DataGridPro or DataGridPremium component to unlock this feature.` : (0, _formatErrorMessage2.default)(91));
    }
    if (newRows.length === 0) {
      return;
    }
    ...
    if (treeDepth > 1) {
      throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: `apiRef.current.unstable_replaceRows` is not compatible with tree data and row grouping' : (0, _formatErrorMessage2.default)(92));
    }
    const tree = (0, _extends2.default)({}, (0, _gridRowsSelector.gridRowTreeSelector)(apiRef));
